...
const NAV_LINKS = ['Skills', 'Experience', 'Projects', 'Contact'] as const;
      ...
      <nav className="v2-nav">
        <div className="v2-nav-inner">
            ...
            {NAV_LINKS.map((label) => (
              <li key={label}>
                <a
                  ...
                  onClick={(e) => { e.preventDefault(); smoothScrollTo(label.toLowerCase()); }}
                >
                  {label}
                </a>
              </li>
          ...
          <div className="v2-nav-actions">
            ...
            <button className="v2-nav-cta" onClick={() => setModalOpen(true)}>
              Get in touch
